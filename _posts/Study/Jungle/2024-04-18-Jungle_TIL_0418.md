...
```cpp
	// 재귀를 통해 탐색 및 삭제 후 연결시켜주는 과정
	if (value < root->item) {		// 이전 노드의 부모와 연결시켜주는 작업 ***
...
#### [RB-Tree의 삽입 과정](https://youtu.be/5IBxA-bZZH8?si=QMG9_res4kLJjjJm)
...
#### [RB-Tree의 삭제 과정](https://youtu.be/iw8N1_keEWA?si=FgsWNm8_AfysqjuH)
##### Transplant
